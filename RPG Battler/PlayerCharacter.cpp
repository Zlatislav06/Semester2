...
const int& PlayerCharacter::getLeval() const
{
	return leval;
}
...
void PlayerCharacter::setHP(int hp)
{
	...
	{
		cout << "the max HP of cheracter can't be a less then zero or zero!";
	}
}
...
void PlayerCharacter::setDamage(int d)
{
	...
	{
		cout << "the max damage of cheracter can't be a less then zero or zero!";
	}
}
void PlayerCharacter::setLeval(int l)
{
	if (l > 0)
	{
		leval = l;
	...
	{
		cout << "the leval of cheracter can't be a less then zero or zero!";
	}
}
